      ...
      <div class="footer__inner">
        ...
        <div class="footer__block">
          <div class="footer__menu">
            <a href="#" class="footer__menu_item active">About</a>
            <a href="#" class="footer__menu_item">Map</a>
            <a href="#" class="footer__menu_item">Zoos</a>
            <a href="#" class="footer__menu_item">Contact us</a>
          </div>
        </div>
        <div class="footer__block afa">
          <div class="footer__sub">
            <div class="footer__sub_title">Subscribe to our news</div>
            <div class="footer__sub_wrapper">
              <input
                type="text"
                class="footer__sub_input"
                placeholder="Enter your email"
              />
              <button class="footer__sub_btn">Submit</button>
            </div>
          </div>
